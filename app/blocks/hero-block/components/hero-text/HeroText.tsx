  ...
  return (
    <div className="flex flex-col justify-start">
      <h1 className="text-6xl font-black">
        ...
        <br /> Web application<br/>framework
      </h1>
      ...
      <div className="flex flex-row justify-start mt-8 gap-4">
        <button className="btn btn-soft rounded-full btn-lg bg-orange-500 hover:bg-orange-700">
          Get Started
        </button>
        <button className="btn btn-soft rounded-full btn-lg ">
          View on Github
        </button>
      </div>
    </div>
